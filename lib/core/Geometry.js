 ...
 * @modify date 2023-01-29 10:46:03
 * @desc [几何体类]
 */
...
class Geometry {
  constructor(gl) {
    ...
    this.m3 = new Matrix3();
    // this.matrix = this.m3.identity();
    this.matrix = this.m3.projection(
  ...
  setRotation(angle) {
    ...
    this.matrix = this.m3.rotate(this.matrix, angle);
    this.setMatrix(this.matrix);
  }
  ...
  setScale(scale) {
    ...
    this.matrix = this.m3.scale(this.matrix, scale[0], scale[1]);
    this.setMatrix(this.matrix);
  }
